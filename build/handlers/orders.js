...
const order_routes = (app) => {
    ...
    app.get('/orders/users/:userid', verifyAuthToken_1.default, showByUser);
    app.post('/orders', verifyAuthToken_1.default, create);
    app.post('/orders/:orderid/products', verifyAuthToken_1.default, checkOrderStatus_1.checkOrderStatus, addProduct);
};
